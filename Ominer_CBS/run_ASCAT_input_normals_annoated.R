############################################################################################################
#
#File name run_ASCAT_input normals.R.R
...
############################################################################################################
##################################################################################################################
#Description: R scripts for calculating log2ratios from raw CEL files for the normal samples using aroma.affymetrix works for all Affymetrix SNP platforms ##########
...
########this is automatically calculated in CNV_shell.R, (5) analysisType = paired/unpaired analysis.

run_ASCAT_input <- function (locations, targets, platform, dataSet) {
