...
########and BAFR_input.txt this is the file containing BAF values. Each file should appear on a separate newline  (2) analysisType - paired/unpaired, (3) platform - type of ######Affymetrix platform of user data ###### (4)  type - CEL or log2ratio (ASCAT can run from log2ratio data - however this option was not incorporated into O-miner , users can only ######use the ASCAT pipeline if they upload raw CEL file data. 
